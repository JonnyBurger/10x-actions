            ...
            case 1:
                ...
                if (is_react_native_app_1.isReactNativeApp(repo)) {
                    if (!((_a = parsedTsConfig === null || parsedTsConfig === void 0 ? void 0 : parsedTsConfig.plugins) === null || _a === void 0 ? void 0 : _a.find(function (p) { return p.name === 'typescript-styled-plugin'; }))) {
                        ...
                        parsedTsConfig.plugins = __spreadArrays(parsedTsConfig.plugins, [tsStyledPlugin]);
                    }
                }
                newFile = JSON.stringify(parsedTsConfig, null, '\t');
                if (!(newFile !== tsConfig)) return [3 /*break*/, 3];
                return [4 /*yield*/, commit_file_1.commitFiles([{ content: newFile, path: tsConfigPath }], 'Enabled skipLibCheck, it is not recommended anymore 🤖')];
            case 2:
                _b.sent();
