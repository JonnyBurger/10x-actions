...
exports.commitFiles = function (files, message) { return __awaiter(void 0, void 0, void 0, function () {
    var octokit, _a, owner, repo, ref, curentRef, latestCommit, tree, commit;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                octokit = get_octokit_1.getOctokit();
                _a = get_context_1.getContext(), owner = _a.owner, repo = _a.repo, ref = _a.ref;
